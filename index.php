      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color : #7d8892;">
              ...
              <div class="col-sm-12 col-md img text-center">
                <img src="img/DMK-Jaoli-Bank-finance-banner.jpg" class="img-fluid ">
              </div>
            </div>
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  ...
                  <div class="col-md act">
                    ...
                    <br>
                    <a href="removeuser.php"><button style="background-color : red;" style="border-radius:0%">Delete Users</button></a>
                  </div>
                  <div class="col-md act">
